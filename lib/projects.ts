...
const projects: Projects = {
  ...
  covid19: {
    ...
    links: {
      github: "https://github.com/githubajaydhage/covid-tracker-material-ui-react",
      live: "https://covid-tracker-beta.vercel.app/",
    },
  },
  covid197: {
    title: "Covid-194 India tracker",
    description: [
      "Covid-19 tracker for India made using **react.**",
      "This web app can be used to track current and historical data of India and its states and union territories. The web app shows a vector **map of India**, user may hover over any state and will be able to see the total confirmed, recovered, active and deceased for that state.",
      "The application is styled using **material-ui** and is fully responsive for all screen sizes and has a **dark mode** toggle. ",
  ...
  connect4: {
    ...
    links: {
      github: "https://github.com/githubajaydhage/connect-4-online-multiplayer",
  ...
  getItDone: {
    ...
    links: {
      github: "https://github.com/githubajaydhage/get-it-done",
  ...
  urlShortener: {
    ...
    links: {
      github: "https://github.com/githubajaydhage/url-shortener-ts-backend",
  ...
  theMealHub: {
    ...
    links: {
      ...
      github: "https://github.com/githubajaydhage/recipe-material-ui",
    },
  ...
  pokemon: {
    ...
    links: {
      ...
      github: "https://github.com/githubajaydhage/pokemon",
    },
  ...
  jokes: {
    ...
    links: {
      ...
      github: "https://github.com/githubajaydhage/Jokes-v2",
    },
    stack: [logos.react, logos.materialui],
    images: {
      main: {
